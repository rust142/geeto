...
- **AI-Powered** — Branch names, commit messages, and release notes generated by Gemini, GitHub Copilot, or OpenRouter
...
| **GitHub Copilot** | Uses Copilot REST API via [GitHub CLI](https://cli.github.com/) token — requires Copilot access (free or paid). |
